...
![版本](https://img.shields.io/badge/version-0.10.20-blue) ![Python](https://img.shields.io/badge/Python-3.10%2B-green) ![Streamlit](https://img.shields.io/badge/Streamlit-1.58-red) ![License](https://img.shields.io/badge/license-MIT-lightgrey)
...
- **v0.10.20（2026-07-25）**：修复常见添加剂（山梨酸钾/磷酸盐等）被标「未识别」与分数虚高：匹配器回退 CSV 风险表，并从复合配料中补捞。`pytest` 101 项通过。
