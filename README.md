...
![版本](https://img.shields.io/badge/version-0.10.19-blue) ![Python](https://img.shields.io/badge/Python-3.10%2B-green) ![Streamlit](https://img.shields.io/badge/Streamlit-1.58-red) ![License](https://img.shields.io/badge/license-MIT-lightgrey)
...
- **v0.10.19（2026-07-25）**：体验修复。配料列表为空时从 OCR 原文恢复；结果页展示重拍提示与原文；手机端语音分句与大号「听结果」；扫描页提示与上传触控区优化。`pytest` 99 项通过。
