...
| 公开链接探活 | ✅ HTTP 200（2026-07-25 探测） |
| L2 模块 compile | ✅ app/scan/profile/result/home |
| 招募执行 | ⏳ 待 owner 以预发布私测方式启动 |
| 有效样本 ≥8 | ⏳ 未开始 |
| Go / Pivot / Stop 判定 | ⏳ 样本达标后 |

## 本周 checklist（owner）

- [ ] 自己手机完整走通 L2（**不要**用 `?demo=1`）
- [ ] 使用受控链接/人工陪跑进行预发布私测，不要求正式发行
- [ ] 列出 30–50 名可邀请子女
- [ ] 发出 ≥15 条微信 1v1 邀请
- [ ] 建体验群（可选）并置顶公开链接 + 免责一句
- [ ] 每完成 1 人：访谈 Q1–Q8 + 写入 CSV
- [ ] 第 5–7 天跟进复扫

> 预发布私测可使用原型、受控测试链接或人工陪跑；正式公开发行、支付和规模化获客均不属于本阶段前置条件。
